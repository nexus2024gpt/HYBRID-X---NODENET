...
Проект распространяется по лицензии **MIT**, что позволяет использовать материалы в исследованиях и разработке, за исключением попыток реконструировать закрытые части Hybrid X.
